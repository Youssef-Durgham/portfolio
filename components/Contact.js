...
<footer className="p-4 bg-[#14243c] sm:p-6  " id="Contacts">
        ...
        <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            ...
            <div>
                ...
                <ul className="text-white/75">
                    <li className="mb-4">
                        <a href="https://github.com/Youssef-Durgham" className="hover:underline ">Github</a>
                    </li>
                    <li>
                        <a href="https://t.me/communication_engineer" className="hover:underline">Telegram</a>
                    </li>
    ...
    <div className="sm:flex sm:items-center sm:justify-between">
        <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="#" className="hover:underline">YOUSEF</a>. All Rights Reserved.
        </span>
        <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
            <a href="https://www.facebook.com/yusif.dhrgam" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
            ...
            <a href="https://github.com/Youssef-Durgham" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
